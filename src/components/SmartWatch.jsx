                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6" style={{textAlign: 'justify'}}>
                                ...
                                <h2> <b>TRAIN & LOG</b> </h2> <h2><b>SEAMLESSLY IN GYM</b></h2> <h2><b>AND HOME</b></h2>  
                            ...
                            <div className="col-md-6">
                                <div className="container">
                                    <img className="img-fluid" src="https://www.jefit.com/wp/wp-content/uploads/2022/08/web2.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
